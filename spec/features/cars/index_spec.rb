  ...
  describe 'As a visitor' do
    describe 'when I visit the child index page' do
      before :each do
        ...
        @car_1 = Car.create!(make: "Tesla", model: "S", year: 2022, auto_pilot: true)
        @car_2 = Car.create!(make: "Tesla", model: "3", year: 2021, auto_pilot: false)
        @car_3 = Car.create!(make: "Tesla", model: "X", year: 2020, auto_pilot: true)
        @car_4 = Car.create!(make: "Tesla", model: "Y", year: 2019, auto_pilot: false)
      end
